...
<p>The Framework component consists of several &quot;projects&quot; in the Equinox GIT
...
<table BORDER=0 CELLSPACING=5 CELLPADDING=2 WIDTH="100%" >
  <tr>
    ...
    <td width="98%"><strong>OSGi R4 Framework (<a href="http://git.eclipse.org/c/equinox/rt.equinox.framework.git/tree/bundles/org.eclipse.osgi/">org.eclipse.osgi</a>)</strong><br>
  ...
  <tr>
    ...
    <td><b>Java Launcher (<a href="http://git.eclipse.org/c/equinox/rt.equinox.framework.git/tree/bundles/org.eclipse.equinox.launcher/">org.eclipse.equinox.launcher</a>)</b><br>
  ...
  <tr>
    <td align=RIGHT valign=TOP><img src="/equinox/images/arrow.png" border="0"></td>
    <td><b>Native Launcher (<a href="http://git.eclipse.org/c/equinox/rt.equinox.framework.git/tree/bundles/org.eclipse.equinox.executable/">org.eclipse.equinox.executable</a>)</b><br>
...
<p>The Framework team typically develops using Eclipse itself so getting and
  ...
  <strong>Import &gt; GIT &gt; Projects from GIT</strong>. Enter the repo access
...
<p>If you are working without Eclipse (gads! :-) then use your favorite GIT client
  and check out the relevant projects.</p>
		  ...
		  <h3>Committers</h3>
			...
			<ul>
				<li>BJ Hargrave, IBM </li>
				<li>DJ Houghton, IBM Rational</li>
				<li>Andrew Niefer, IBM</li>
				<li>Pascal Rapicault, Individual</li>
				<li>Tom Watson, IBM (Project lead)</li>
			</ul>
	</div>
